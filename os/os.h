...
void          OSMutexPend(OS_EVENT *pevent, INT16U timeout, INT8U *err);		//获取互斥信号量
INT8U         OSMutexPost(OS_EVENT *pevent);									//释放互斥信号量
...
void          OSSchedLock(void);		//关任务调度，被关闭后，任务不能进行正常的切换
void          OSSchedUnlock(void);		//开任务调度
#endif
