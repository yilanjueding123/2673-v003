...
/*INT32S*/INT64S fs_fseek(INT16S fd, INT32S foffset, INT16S origin);
...
//查找当前目录下的第一个文件
f_ppos sfn_findfirst(STDiskFindControl *pstDiskFindControl, INT8S dsk, CHAR *extname, struct sfn_info *sfn_info, INT16S attr);
//查找当前目录下的文件
f_ppos sfn_findnext(STDiskFindControl *pstDiskFindControl, INT8S dsk, CHAR *extname, struct sfn_info *sfn_info, INT16S attr);
//进入子目录
...
f_ppos fs_getfirstfile(STDiskFindControl *pstDiskFindControl, INT16S dsk, INT8S *extname, struct sfn_info *f_info, INT16S attr, INT8S speedup);
f_ppos fs_getnextfile(STDiskFindControl *pstDiskFindControl, INT16S dsk, INT8S *extname, struct sfn_info *f_info, INT16S attr, INT8S speedup);
...
f_ppos fs_get_first_file_in_folder(STDiskFindControl *pstDiskFindControl, INT8S *path, INT8S *extname, struct sfn_info *f_info, INT16S attr, INT8S find_child_dir);
f_ppos fs_get_next_file_in_folder(STDiskFindControl *pstDiskFindControl, INT8S *path, INT8S *extname, struct sfn_info *f_info, INT16S attr, INT8S find_child_dir);
