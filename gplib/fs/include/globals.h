...
extern ALIGN32 INT8U sd_cache_ram[SDC_FAT_CACHE_SIZE];
...
extern st_FatSpeedUpNode	gFatSpeedupBuf[FAT_SPEEDUP_TAB_ENTRY];
#endif
...
extern INT32S CheckFreeSize(INT16S dsk, INT32U size); //size is byte size
extern INT32S AddFreeCluster(INT16S dsk, INT32U start_cls, INT32U length); //unit:cluster
extern INT32S DelFreeCluster(INT16S dsk, INT32U start_cls, INT32U length); //unit:cluster
