...
extern INT32S jpeg_decode_level4_scaledown_enable(void);			// When scale-down level 4 mode is enabled, output size will be 1/4 in width and height
extern INT32S jpeg_decode_level4_scaledown_disable(void);
