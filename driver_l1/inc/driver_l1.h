...
#define   LDO_12_11V					0x0010
#define   LDO_12_12V					0x0030
#define   LDO_12_13V					0x0050
#define   LDO_12_14V					0x0070
extern void sys_ldo12_ctrl(int voltage);

#define   LDO_33_30V					0x0000
#define   LDO_33_31V					0x0400
#define   LDO_33_32V					0x0800
#define   LDO_33_33V					0x0C00
extern void sys_ldo33_ctrl(int enable, int voltage);

#define   LDO_28_28V					0x0000
#define   LDO_28_29V					0x0100
#define   LDO_28_30V					0x0200
#define   LDO_28_31V					0x0300
extern void sys_ldo28_ctrl(int enable, int voltage);
#endif
...
// NAND FLASH
#ifndef __NAND_TYPEDEF__
#define __NAND_TYPEDEF__
...
#endif  //__NAND_TYPEDEF__

#ifndef _NAND_STATUS_ENUM
#define _NAND_STATUS_ENUM
typedef enum
{
    NAND_TRUE = 0,
    NAND_OK = 0,
...
extern void Nand_BCH_force_mode_set(BCH_MODE_ENUM bch_mode);
extern INT32U nand_total_Byte_size_get(void);
...
#if (defined _DRV_L1_IR) && (_DRV_L1_IR == 1)
extern void uart0_isr(void);
extern void	uart_user_isr_set(void (*user_isr)(void));
extern void uart_user_isr_clr(void);
...
//gamman table init
extern void tft_cpt_claa070ld0acw_gamma_init(void);
...
INT32S drvl1_sdc_init(void);
INT32S drvl1_sdc_enable(void);
INT32S drvl1_sdc_disable(void);
INT32S drvl1_sdc_controller_busy_wait(INT32U timeout);
INT32S drvl1_sdc_clock_set(INT32U speed);
INT32S drvl1_sdc_block_len_set(INT32U size);
INT32S drvl1_sdc_bus_width_set(INT8U width);
INT32S drvl1_sdc_stop_controller(INT32U timeout);
// SD Controller: APIs for SD card
extern INT32S drvl1_sdc_card_init_74_cycles(void);
extern INT32S drvl1_sdc_card_busy_wait(INT32U timeout);
extern INT32S drvl1_sdc_command_send(INT32U command, INT32U argument);
extern INT32S drvl1_sdc_response_get(INT32U *response, INT32U timeout);
extern INT32S drvl1_sdc_data_get(INT32U *buf, INT32U timeout);
extern INT32S drvl1_sdc_command_complete_wait(INT32U timeout);
extern void drvl1_sdc_clear_rx_data_register(void);
extern INT32S drvl1_sdc_read_data_by_dma(INT32U *buffer, INT32U sector_count, INT8S *poll_status);
extern INT32S drvl1_sdc_write_data_by_dma(INT32U *buffer, INT32U sector_count, INT8S *poll_status);
extern INT32S drvl1_sdc_data_complete_wait(INT32U timeout);
extern INT32S drvl1_sdc_data_crc_status_get(void);
...
extern INT32U GetCSWResidue(INT32U *GetHostBuffer_PTR);
...
extern void usbd_desc_jpg_size_set(INT16U width, INT16U height);
...
//GPL326xx Hardware IR function
#if (defined _DRV_L1_IR) && (_DRV_L1_IR == 1)
extern void drv_l1_ir_init(void);
extern void ir_int_from_uart(void);
extern void drv_l1_IR_RX_Enable(void);
extern void drv_l1_IR_RX_FIFO_INT_Enable(void);
extern void drv_l1_IR_RX_Disable(void);
#endif
