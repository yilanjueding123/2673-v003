...
#define P_USBD_ISOIER               ((volatile INT32U *) (P_USBD_BASE + 0x0174))
#define P_USBD_ISOIR                ((volatile INT32U *) (P_USBD_BASE + 0x0178))
...
#define	P_USBD_EPEVENRCLEAR			((volatile INT32U *) (P_USBD_BASE + 0x0100))
...
#if USED_MCU_NAME == MCU_GPDV6655D // 2016-04-26 liuxi
#define R_SYSTEM_LDO_CTRL               (*((volatile INT32U *) 0xD0000020))
#else
#define R_SYSTEM_LVR_CTRL               (*((volatile INT32U *) 0xD0000020))
#endif
...
#if USED_MCU_NAME == MCU_GPDV6655D // 2016-04-26 liuxi
#define R_SYSTEM_POWER_CTRL1			(*((volatile INT32U *) 0xD0000088))
#endif
