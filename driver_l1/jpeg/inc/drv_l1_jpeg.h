...
#define C_JPG_CTRL_YUYV_L2_SCALEDOWN_EN	0x08000000
#define C_JPG_CTRL_YUYV_L4_SCALEDOWN_EN	0x10000000
...
#define C_JPG_CTRL_IMAGE_SIZE_SET		0x80000000		// When decompressing to YUYV with 1/2 or 1/4 scale-down, set this bit(and set image size to 1/4 or 1/16 of original size) to prevent memory from overwritten by JPEG engine
...
#define C_JPG_INT_DECODE_OUT_FULL_EN	0x00000004
#define C_JPG_INT_READ_EMPTY_EN			0x00000008
#define C_JPG_INT_ENCODE_OUT_FULL_EN	0x00000040

// Interrupt pending register
#define C_JPG_INT_COMP_PEND				0x00000001
#define C_JPG_INT_DECOMP_PEND			0x00000002
#define C_JPG_INT_DECODE_OUT_FULL_PEND	0x00000004
...
#define C_JPG_INT_ENCODE_OUT_FULL_PEND	0x00000040
#define C_JPG_INT_MASK					0x0000017F
