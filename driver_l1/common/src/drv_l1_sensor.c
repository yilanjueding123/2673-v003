...
//	Return:			None
//====================================================================================================
static INT32U sensor_sta_cnt = 0;

void clear_sensor_sta(void)
{
	sensor_sta_cnt = 0;
}

void sensor_sta_count(void)
{
	sensor_sta_cnt++;
}

INT32U sensor_sta_get(void)
{
	return sensor_sta_cnt;
}

INT16U read_sensor_status(void)
{
	INT8U id1, id2;
	
	id1 = sccb_read(SLAVE_ID,0xfc);
    id2 = sccb_read(SLAVE_ID,0xfd);

    if((id1 != 0x39)||(id2 != 0x25))
    {
		return 0;
    }
...
//		sccb_write(SLAVE_ID, 0xe3,0x8c);
//		sccb_write(SLAVE_ID, 0xe4,0x81);
//		sccb_write(SLAVE_ID, 0xe9,0x18);
//		sccb_write(SLAVE_ID, 0xe7,0x80);
//		sccb_write(SLAVE_ID, 0xff,0x00);
//		sccb_write(SLAVE_ID, 0x01,0x00);
//		sccb_write(SLAVE_ID, 0x02,0x20);
//		sccb_write(SLAVE_ID, 0xff,0x01);
//		sccb_write(SLAVE_ID, 0xe5,0x30);
//		sccb_write(SLAVE_ID, 0xff,0x00);
//		sccb_write(SLAVE_ID, 0x05,0xf8);
...
//		sccb_write(SLAVE_ID, 0x8b,0x12);
//		sccb_write(SLAVE_ID, 0x91,0x45);
//		sccb_write(SLAVE_ID, 0x93,0x0c);
//		sccb_write(SLAVE_ID, 0xff,0x00);
//		sccb_write(SLAVE_ID, 0xa2,0x10);
//		sccb_write(SLAVE_ID, 0xa3,0x28);
//		sccb_write(SLAVE_ID, 0xa4,0x08);
//		sccb_write(SLAVE_ID, 0xa5,0x26);
//		sccb_write(SLAVE_ID, 0xa7,0x1b);
//		sccb_write(SLAVE_ID, 0xa8,0x14);
//		sccb_write(SLAVE_ID, 0xa9,0x14);
//		sccb_write(SLAVE_ID, 0xaa,0x14);
//		sccb_write(SLAVE_ID, 0xab,0x18);
//		sccb_write(SLAVE_ID, 0xac,0x4c);
//		sccb_write(SLAVE_ID, 0xad,0xff);
//		sccb_write(SLAVE_ID, 0xae,0x47);
//		sccb_write(SLAVE_ID, 0xb2,0x89);
//		sccb_write(SLAVE_ID, 0xb3,0x66);
//		sccb_write(SLAVE_ID, 0xb4,0x00);
//		sccb_write(SLAVE_ID, 0xb5,0x09);
//		sccb_write(SLAVE_ID, 0xb6,0xd9);
//		sccb_write(SLAVE_ID, 0xb8,0xca);
//		sccb_write(SLAVE_ID, 0xbb,0x0d);
//		sccb_write(SLAVE_ID, 0xbc,0x14);
//		sccb_write(SLAVE_ID, 0xbd,0x10);
//		sccb_write(SLAVE_ID, 0xbe,0x24);
...
//		sccb_write(SLAVE_ID, 0xcd,0x3f);
//		sccb_write(SLAVE_ID, 0xd0,0x89);
//		sccb_write(SLAVE_ID, 0xd1,0x82);
//		sccb_write(SLAVE_ID, 0xd2,0x86);
//		sccb_write(SLAVE_ID, 0xd3,0x87);
//		sccb_write(SLAVE_ID, 0xd4,0x84);
//		sccb_write(SLAVE_ID, 0xd5,0x8a);
//		sccb_write(SLAVE_ID, 0xd6,0x61);
//		sccb_write(SLAVE_ID, 0xff,0x01);
//		sccb_write(SLAVE_ID, 0x00,0x05);
//		sccb_write(SLAVE_ID, 0x01,0x88);
//		sccb_write(SLAVE_ID, 0x04,0x38);
//		sccb_write(SLAVE_ID, 0x05,0x48);
//		sccb_write(SLAVE_ID, 0x07,0x92);
//		sccb_write(SLAVE_ID, 0x09,0x85);
//		sccb_write(SLAVE_ID, 0x0b,0x81);
//		sccb_write(SLAVE_ID, 0x0c,0xbf);
//		sccb_write(SLAVE_ID, 0x0d,0xa0);
//		sccb_write(SLAVE_ID, 0x16,0x8a);
//		sccb_write(SLAVE_ID, 0x17,0xb4);
//		sccb_write(SLAVE_ID, 0x19,0x9a);
//		sccb_write(SLAVE_ID, 0x1b,0x38);
//		sccb_write(SLAVE_ID, 0x1c,0x70);
//		sccb_write(SLAVE_ID, 0x1d,0x55);
//		sccb_write(SLAVE_ID, 0x1e,0x80);
//		sccb_write(SLAVE_ID, 0x1f,0xcc);
//		sccb_write(SLAVE_ID, 0xff,0x01);
//		sccb_write(SLAVE_ID, 0x30,0xc0);
//		sccb_write(SLAVE_ID, 0x34,0xc8);
//		sccb_write(SLAVE_ID, 0x35,0xb8);
//		sccb_write(SLAVE_ID, 0x36,0xff);
//		sccb_write(SLAVE_ID, 0x37,0xd0);
//		sccb_write(SLAVE_ID, 0x38,0x43);
//		sccb_write(SLAVE_ID, 0x3b,0x08);
//		sccb_write(SLAVE_ID, 0xff,0x00);
//		sccb_write(SLAVE_ID, 0x80,0x0f);
//		sccb_write(SLAVE_ID, 0x81,0x1e);
//		sccb_write(SLAVE_ID, 0x83,0x37);
//		sccb_write(SLAVE_ID, 0x85,0x78);
//		sccb_write(SLAVE_ID, 0x86,0xfc);
//		sccb_write(SLAVE_ID, 0x87,0x00);
//		sccb_write(SLAVE_ID, 0x88,0x02);
//		sccb_write(SLAVE_ID, 0x89,0xca);
//		sccb_write(SLAVE_ID, 0x8a,0x44);
//		sccb_write(SLAVE_ID, 0x8b,0x44);
//		sccb_write(SLAVE_ID, 0x91,0x42);
//		sccb_write(SLAVE_ID, 0x92,0x54);
//		sccb_write(SLAVE_ID, 0x93,0x0c);
//		sccb_write(SLAVE_ID, 0xff,0x00);
//		sccb_write(SLAVE_ID, 0xb5,0x01);
//		sccb_write(SLAVE_ID, 0x70,0x01);
//		sccb_write(SLAVE_ID, 0x71,0x30);
//		sccb_write(SLAVE_ID, 0x72,0x2c);
//		sccb_write(SLAVE_ID, 0x73,0x2c);
//		sccb_write(SLAVE_ID, 0xc0,0x89);
//		sccb_write(SLAVE_ID, 0xc1,0x82);
//		sccb_write(SLAVE_ID, 0xc2,0x86);
//		sccb_write(SLAVE_ID, 0xc3,0x87);
//		sccb_write(SLAVE_ID, 0xc4,0x84);
//		sccb_write(SLAVE_ID, 0xc5,0x8a);
//		sccb_write(SLAVE_ID, 0xff,0x01);
//		sccb_write(SLAVE_ID, 0x15,0x62);
//		sccb_write(SLAVE_ID, 0x18,0xff);
//		sccb_write(SLAVE_ID, 0x3e,0x81);
//		sccb_write(SLAVE_ID, 0xe2,0xa4);
//		sccb_write(SLAVE_ID, 0xff,0x00);
//		sccb_write(SLAVE_ID, 0x6f,0x30);
//		sccb_write(SLAVE_ID, 0xff,0x01);
//		sccb_write(SLAVE_ID, 0x31,0x43);
//		sccb_write(SLAVE_ID, 0x32,0xa0);
//		sccb_write(SLAVE_ID, 0x33,0x20);
//		sccb_write(SLAVE_ID, 0x39,0xb0);
//	}
	{
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0xf2, 0x01);
...
//	{
//		uart_send_data(APP_NO_LENS_STATE);
//	}
}
#endif
